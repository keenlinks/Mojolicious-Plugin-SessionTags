...
throws_ok { $c->is_tag( 'dodo1' ) } qr/"dodo1" is not a valid session tag for Mojolicious\:\:Plugin\:\:SessionTags/, 'is_tag with non-existant tag input caught error ok';
throws_ok { $c->is_tag( 'dodo2' ) } qr/"dodo2" is not a valid session tag for Mojolicious\:\:Plugin\:\:SessionTags/, 'is_tag with non-existant tag input caught error ok';
throws_ok { $c->is_tag( 'dodo3' ) } qr/"dodo3" is not a valid session tag for Mojolicious\:\:Plugin\:\:SessionTags/, 'is_tag with non-existant tag input caught error ok';
...
throws_ok { $c->is_tag } qr/No input provided for Mojolicious\:\:Plugin\:\:SessionTags/, 'is_tag with no tag input caught error ok';
