...
throws_ok { $c->is_role( 'dodo1' ) } qr/"dodo1" is not a valid session tag for Mojolicious\:\:Plugin\:\:SessionTags/, 'is_role with non-existant role input caught error ok';
throws_ok { $c->is_role( 'dodo2' ) } qr/"dodo2" is not a valid session tag for Mojolicious\:\:Plugin\:\:SessionTags/, 'is_role with non-existant role input caught error ok';
throws_ok { $c->is_role( 'dodo3' ) } qr/"dodo3" is not a valid session tag for Mojolicious\:\:Plugin\:\:SessionTags/, 'is_role with non-existant role input caught error ok';
...
throws_ok { $c->is_role } qr/No input provided for Mojolicious\:\:Plugin\:\:SessionTags/, 'is_role with no role input caught error ok';
